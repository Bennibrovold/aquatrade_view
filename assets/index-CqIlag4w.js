...
`;function Y(e){return(e+1)%P.length}function J(e,s){return o.jsx(U,{style:{...e,backgroundImage:`url(${P[s]})`}})}const Q=()=>{const e=v.useRef(null),s=B(i=>i.less.md),t=["нержавеющей стали","цветных и чёрных металлов"];return v.useEffect(()=>{var i=new q(e.current,{strings:t,typeSpeed:30,loop:!0});return()=>{i.destroy()}},[]),o.jsx(V,{children:o.jsxs(j,{children:[o.jsxs(K,{children:[o.jsx(X,{children:"Акватрэйд"}),o.jsxs(tt,{children:["мы созадём изделия ",o.jsx("br",{})," из ",o.jsx("span",{ref:e})]}),s?o.jsx(T,{children:o.jsx(S,{})}):null,o.jsxs(st,{children:[o.jsx(et,{onClick:()=>window.location.href="tel:+79147907063",children:"Позвонить"})," ","или ",o.jsx("a",{href:"#feedback",children:"оставить заявку"})]})]}),s?null:o.jsx(T,{children:o.jsx(S,{})})]})})},V=c.div`
  height: calc(700px);
  margin-top: 180px;
  margin-bottom: 100px;
